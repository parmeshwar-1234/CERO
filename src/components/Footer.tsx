      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-12">
          <div className="col-span-2 md:col-span-4 lg:col-span-1">
            <h3 className="text-2xl font-bold text-white mb-4">CERO</h3>
            <p className="text-gray-400 mb-6 leading-relaxed">
              India's first Government-Authorized Vehicle Recycler.
            </p>
            <p className="text-sm text-gray-500 mb-4">
              A Mahindra + MSTC Joint Venture
            </p>
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              © {new Date().getFullYear()} CERO. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-sm">
              ...
              <div className="flex items-center gap-2">
                <div className="w-2 h-2 bg-emerald-500 rounded-full"></div>
                <span className="text-gray-500">Government Authorized</span>
              </div>
            </div>
          </div>
        </div>
